...
// SWIG interface to C++ ExponentialCohesiveZoneNoHeal object.

/* This is nearly identical to the C++ ExponentialCohesiveZoneNoHeal header
 * file. There are a few important differences required by SWIG:
 *
 * (1) Instead of forward declaring the ExponentialCohesiveZoneNoHeal class, we
...
namespace contrib {
  namespace friction {
    ...
    class ExponentialCohesiveZoneNoHeal : public pylith::friction::FrictionModel
