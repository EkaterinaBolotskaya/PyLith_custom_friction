...
// SWIG interface to C++ ParabolicCohesiveZoneNoHeal object.

/* This is nearly identical to the C++ ParabolicCohesiveZoneNoHeal header
 * file. There are a few important differences required by SWIG:
 *
 * (1) Instead of forward declaring the ParabolicCohesiveZoneNoHeal class, we
...
namespace contrib {
  namespace friction {
    ...
    class ParabolicCohesiveZoneNoHeal : public pylith::friction::FrictionModel
