...
/* @brief C++ ExponentialCohesiveZoneNoHeal object that implements friction
 * correlated with slip rate.
 *
 * implemented by Ekaterina Bolotskaya (modified from ViscousFriction example)
 *
 * Friction model in which the friction coefficient evolves exponentially with slip.
 * The physical properties are specified using cohesion, static friciton coefficient (mu_s),
 * dynamic friction coefficient (mu_d), slip_shift (D_1) and slip_stretch (D_2).
 *
 *\mu = \mu_d + (\mu_s-\mu_d)\frac{D+D_1}{D_2} e^{1-\frac{D+D_1}{D_2}}
 */

#if !defined(pylith_friction_ExponentialCohesiveZoneNoHeal_hh)
#define pylith_friction_ExponentialCohesiveZoneNoHeal_hh
...
namespace contrib {
  namespace friction {
    class ExponentialCohesiveZoneNoHeal;
  } // friction
} // pylith

// ExponentialCohesiveZoneNoHeal -------------------------------------------------------
class contrib::friction::ExponentialCohesiveZoneNoHeal : public pylith::friction::FrictionModel
{ // class ExponentialCohesiveZoneNoHeal
  friend class TestExponentialCohesiveZoneNoHeal; // unit testing
...
public :
  ...
  /// Default constructor.
  ExponentialCohesiveZoneNoHeal(void);
...
private :
  ...
  ExponentialCohesiveZoneNoHeal(const ExponentialCohesiveZoneNoHeal&); ///< Not implemented.
  const ExponentialCohesiveZoneNoHeal& operator=(const ExponentialCohesiveZoneNoHeal&); ///< Not implemented

}; // class ExponentialCohesiveZoneNoHeal

#endif // pylith_friction_ExponentialCohesiveZoneNoHeal_hh
