...
// SWIG interface to C++ DoubleSlipWeakeningFrictionNoHeal object.

/* This is nearly identical to the C++ DoubleSlipWeakeningFrictionNoHeal header
 * file. There are a few important differences required by SWIG:
 *
 * (1) Instead of forward declaring the DoubleSlipWeakeningFrictionNoHeal class, we
...
namespace contrib {
  namespace friction {
    ...
    class DoubleSlipWeakeningFrictionNoHeal : public pylith::friction::FrictionModel
